...
export function validPublicWebsiteUrl(value) {
  const normalized = validMediaUrl(value);
...
export function getProductWebsitePreview(product) {
  const websiteUrl =
    validPublicWebsiteUrl(product?.website_url) ||
    validPublicWebsiteUrl(product?.company?.website_url);
